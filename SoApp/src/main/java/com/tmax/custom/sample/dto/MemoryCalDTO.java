...
import com.tmax.proobject.runtime.memory.validator.Memory;

@javax.annotation.Generated(
	value = "com.tmaxsoft.sts4.codegen.dto.DtoGenerator",
	date= "24. 1. 10. 오후 2:13"
)

@com.tmax.proobject.core2.annotation.DataObject
public class MemoryCalDTO extends DataObject implements Serializable, Cloneable {
    ...
    @Memory(fieldUnitSizeCheck = true, fieldUnitSizeLimit = 10)
    ...
    @Override
    public Object clone() {
    	MemoryCalDTO copyObj = new MemoryCalDTO();
    	copyObj.clone(this);
    	return copyObj;
    }
    
    public void clone(Object _memoryCalDTO){
    	if (this == _memoryCalDTO)
    		return;
    		
    	MemoryCalDTO __memoryCalDTO = (MemoryCalDTO) _memoryCalDTO;
    	this.setEmpno(__memoryCalDTO.getEmpno());
    	this.setEname(__memoryCalDTO.getEname());
    }
