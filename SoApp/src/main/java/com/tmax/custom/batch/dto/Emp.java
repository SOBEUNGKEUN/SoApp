...
@javax.annotation.Generated(
	...
	date= "23. 12. 18. 오전 11:35"
)

@com.tmax.proobject.core2.annotation.DataObject
public class Emp extends DataObject implements Serializable, Cloneable {
    ...
    public void clone(Object _emp){
    	if (this == _emp)
    		return;
    		
    	Emp __emp = (Emp) _emp;
    	this.setEmpno(__emp.getEmpno());
    	this.setEname(__emp.getEname());
    }
